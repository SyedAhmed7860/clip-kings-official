document.addEventListener('DOMContentLoaded', () => {
    ...
    function initPageScripts(container) {
        ...
        // FIX: The hamburger menu was moving towards the center because
        // it or its parent was receiving GSAP transformations on scroll.
        // We explicitly ignore the header and its children from being animated by generic GSAP scroll triggers.
        if (typeof gsap !== 'undefined' && typeof ScrollTrigger !== 'undefined') {
            const revealElements = container.querySelectorAll('.gs-reveal');
            
            revealElements.forEach((el) => {
                // Ignore elements inside the header to prevent unwanted transform inheritance
